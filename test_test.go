...
func TestBackup(t *testing.T) {
	...
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 338)
	...
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 353)
	// lots of successful commands to new group.
	for i := 0; i < 50; i++ {
		cfg.one(rand.Int(), 3)
	}
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 358)
	...
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 366)
	...
	time.Sleep(RaftElectionTimeout / 2)
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 373)
	...
	cfg.connect(other)
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 381)
	// lots of successful commands to new group.
	for i := 0; i < 50; i++ {
		cfg.one(rand.Int(), 3)
	}
	//fmt.Println("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk", 386)
	// now everyone
	for i := 0; i < servers; i++ {
		cfg.connect(i)
	}
